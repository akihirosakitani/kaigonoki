          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4">
                <Button href="https://kaigonoki.wordpress.com/" isExternal size="lg">介護の「キ」メディア</Button>
                <Button href="https://note.com/kaigo_no_ki" isExternal variant="teal" size="lg">noteを読む</Button>
